				...
				function() {
					...
					.click(
							function() {
								...
								$
										.ajax({
											url : 'http://localhost:8080/blog/online/user/addPost',											
											type : 'post',
											contentType : 'application/json',
											success : function(response) {
												console.log(response);
					...
					function updatePostList(postListt)
					{
						var div = document.getElementById("postList");
						//Comment below 'data' var and change the input parameter as 'data'
						var data = '[{"id":1,"title":"mytitle","body":"mybody","user":{"email":"ate@ate.ate","userposts":[],"password":null,"name":null},"createdTime":null},{"id":2,"title":"mytitle2","body":"mybody2","user":{"email":"ate@ate.ate","userposts":[],"password":null,"name":null},"createdTime":null}]';
						...
						for(i=0;i<postlist.length;i++)
						{
							...
							div.innerHTML += "<p><b><a href='http://localhost:8080/blog/online/user/getPost?id="+json.id+"'>"+json.title+"</a>"+ "</b><br><i>" + json.createdTime + "</i><br>" + json.body+"</p>";
						}
					}
